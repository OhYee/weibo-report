...
class WeiboLogin(object):
    ...
    def __init__(self, user, password, proxy):
        ...
        self.session.get(self.index_url, headers=headers,
...
if __name__ == '__main__':
    username = "896817156@qq.com"  # 用户名
    password = "OYohyee123"  # 密码
    cookie_path = "./cookie"  # 保存cookie 的文件名称
